defmodule Slate.Accounts.User do
  @moduledoc """
  User Schema Module
  """
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Slate.Repo)
  ...
  """
  def valid_password?(%Slate.Accounts.User{hashed_password: hashed_password}, password)
